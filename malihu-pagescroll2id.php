...
function malihuPageScroll2id_setup(){
	...
	wp_register_script("jquery-malihu-PageScroll2id", WP_PLUGIN_URL."/malihu-pagescroll2id/jquery.malihu.PageScroll2id.js",array("jquery","jquery-effects-core"), "1.0",1);
	wp_enqueue_script("jquery-malihu-PageScroll2id");
	wp_register_script("jquery-malihu-PageScroll2id-init", WP_PLUGIN_URL."/malihu-pagescroll2id/jquery.malihu.PageScroll2id-init.js",array("jquery","jquery-effects-core","jquery-malihu-PageScroll2id"), "1.0",1);
